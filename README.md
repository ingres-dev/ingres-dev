...
Linguagens e Frameworks: Java (com Spring Boot), Node.js (com Express), C#, HTML, CSS, JavaScript, Python.





Bancos de Dados: PostgreSQL, MongoDB, MySQL & SQL.
...
Arquitetura: Experiência com arquitetura de Microsserviços, construção de APIs RESTful, e utilização de API Gateway (como Kong/Spring Cloud Gateway/Ocelot) para roteamento, autenticação (JWT) e rate limiting.
...
Colaboração: Trabalho bem em equipe, sou comunicativo e adaptável.
